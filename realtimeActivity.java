...
public class realtimeActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void getDataFromFirebase(){
        ...
        modelClass.addValueEventListener(new ValueEventListener() {
            @Override
                    ...
                    myRecyclerViewHolder.setOnCLickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            Toast.makeText(getApplicationContext(),
                                    ":" + list.get(   Reciclerview.getChildAdapterPosition(view)).
                                            getId(), Toast.LENGTH_SHORT).show();

                            txtActivity.setText(list.get(   Reciclerview.getChildAdapterPosition(view)).getActivity());
                            txtActivity.setFocusable(true);
                            idSeleccionado = list.get(   Reciclerview.getChildAdapterPosition(view)).getId();
    ...
    public void deleteNode(String id){
        if(id != null){
            ...
            Toast.makeText(getApplicationContext(),"selecciona un elemento", Toast.LENGTH_SHORT).show();
